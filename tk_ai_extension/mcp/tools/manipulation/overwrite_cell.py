        ...
        **kwargs
        ...
        try:
            ...
            if not ydoc:
                ...
                from ..utils.contents_fallback import overwrite_cell_via_contents
                return await overwrite_cell_via_contents(contents_manager, notebook_path, cell_index, source)
